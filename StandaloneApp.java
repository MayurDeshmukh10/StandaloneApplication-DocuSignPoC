...
public class StandaloneApp {
    ...
    private String createJSONString(String docBase64json,String document_type,String name,String email)
    {
    ...
    private void sendPost() throws Exception{
        ...
        String jsonInputString = createJSONString(docBase64, doc_type,signer_name, signer_email);
