...
public class StandaloneApp {
    ...
    private void sendPost() throws Exception
    {
        ...
        System.out.println();
	    System.out.println("SUCCESSFULLY SENT THE DOCUMENT FOR SIGNATURE");
        }
    ...
    private void authenticate() throws Exception
    {
        ...
        con.setRequestProperty("Accept-Language","en-US,en;q=0.8,fa;q=0.6,sv;q=0.4");
        con.setRequestProperty("Cache-Control","no-cache");
        con.setRequestProperty("Origin","https://apiexplorer.docusign.com");
        con.setRequestProperty("Referer","https://apiexplorer.docusign.com/");
        con.setRequestProperty("User-Agent","Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/74.0.3729.169 Chrome/74.0.3729.169 Safari/537.36");
        con.setRequestProperty("X-DocuSign-Authentication","{ \"Username\":"+username+", \"Password\":"+password+", \"IntegratorKey\":"+integration_key+" }");     //legacy authentication 
        con.setRequestProperty("Content-Type","application/json");
